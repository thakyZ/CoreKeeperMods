...
namespace UnityExplorer.UI.Panels
{
    internal class FreeCamPanel : UEPanel
    {
        ...
        public override UE_UIManager.Panels PanelType => UE_UIManager.Panels.Freecam;
        ...
        internal static void BeginFreecam()
        {
            ...
            previousMousePosition = UInputManager.MousePosition;
    ...
    internal class FreeCamBehaviour : MonoBehaviour
    {
        ...
        internal void Update()
        {
            if (FreeCamPanel.inFreeCamMode)
            {
                ...
                if (UInputManager.GetKey(KeyCode.LeftShift) || UInputManager.GetKey(KeyCode.RightShift))
                    moveSpeed *= 10f;
                ...
                {
                    Vector3 mouseDelta = UInputManager.MousePosition - FreeCamPanel.previousMousePosition;
                ...
                FreeCamPanel.previousMousePosition = UInputManager.MousePosition;
            }
        }
    }
}
